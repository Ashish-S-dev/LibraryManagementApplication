...
//      Display Image of the Application
        ...
        ImageIcon tableimg=new ImageIcon(ClassLoader.getSystemResource("librarymanagementsystem/icons/student.png"));
        Image tableimg2=tableimg.getImage().getScaledInstance(1000, 500,Image.SCALE_DEFAULT);
        ImageIcon tableimg3=new ImageIcon(tableimg2);
        JLabel tableimg4=new JLabel(tableimg3);
        tableimg4.setBounds(350,150,1000,500);
        add(tableimg4);
