...
public class USearchByCategory extends JFrame implements ActionListener{
    Choice cbcategory;
    JButton jbsearch,ref4;
    JTable table;
    public USearchByCategory(){
        setLayout(null);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==jbsearch){
            ...
            if(!cbcategory.getSelectedItem().equals("Select")){
                ...
                JOptionPane.showMessageDialog(null, "Please Select Book Category","",JOptionPane.ERROR_MESSAGE);
            }
