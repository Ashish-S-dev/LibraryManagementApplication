...
//        Heading of the Page
        ...
        JLabel heading=new JLabel("Issue Book To Student");
        ...
        try{
            conn2 =new Conn();
            ResultSet rs=conn2.s.executeQuery("Select ReferenceNo from student");
            while(rs.next()){
        ...
        lblcourse.setBounds(40,525,90,20);
        add(lblcourse);
        ...
        tfyear=new JLabel();
        tfyear.setBounds(410,525,140,20);
        ...
        if(ae.getSource()==fetchbook){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "User Deatails Not Found","",JOptionPane.ERROR);
                }
            }catch(Exception e){
                e.printStackTrace();
            }
            ...
            try{
                conn=new Conn();
                ResultSet rs=conn.s.executeQuery("select * from student where ReferenceNo='"+studid+"'");
                if(rs.next()){
            ...
            if(!bookname.equals("")&& !stuname.equals("") && !issuedate.equals("")){
                ...
                try{
                    ...
                    String query2="Insert into issuedbook value('"+bookref+"','"+bookname+"','"+studid+"','"+stuname+"','"+issuedate+"','Student')";
