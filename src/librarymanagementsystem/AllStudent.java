...
public class AllStudent extends JFrame implements ActionListener {
    ...
    public AllStudent(){
        ...
        JLabel heading =new JLabel("Student Data");
        ...
        try{
            conn=new Conn();
            String qurey="Select ReferenceNo,Name,Number,Email,Gender,UniRoll,Department,Course from student ORDER BY Name ASC";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==ref4){
            ...
            if(!tfname.getText().equals("")){
                ...
                try{
                    conn =new Conn();
                    ResultSet rs2=conn.s.executeQuery("Select ReferenceNo,Name,Number,Email,Gender,UniRoll,Department,Course from student where Name='"+tfname.getText()+"'");
