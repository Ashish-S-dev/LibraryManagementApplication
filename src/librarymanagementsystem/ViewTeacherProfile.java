...
public class ViewTeacherProfile extends JFrame implements ActionListener{
...
//        Form part
        ...
        lbldob.setBounds(550,190,190,20);
        add(lbldob);
        ...
        lbldep.setBounds(550,405,200,20);
        add(lbldep);
        
        JLabel jcdep=new JLabel();
        jcdep.setBounds(850,405,250,20);
        ...
        lblquali.setBounds(550,450,200,20);
        add(lblquali);
        
        JLabel jcquali=new JLabel();
        jcquali.setBounds(850,450,250,20);
        ...
        lblyear.setBounds(550,495,200,20);
        add(lblyear);
        
        JLabel jcbdoj=new JLabel();
        jcbdoj.setBounds(850,495,150,20);
