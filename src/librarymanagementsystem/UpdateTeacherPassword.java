...
public class UpdateTeacherPassword extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==jbcancel){
            ...
            if(!userid.equals("")){
                ...
                try{
                    conn=new Conn();
                    ResultSet rs=conn.s.executeQuery("Select * from Teacher where ReferenceNo='"+userid+"' and Password='"+oldpass+"'");
                    if(rs.next()){
                        try{
                            String query="Update Teacher set Password='"+newpass+"' where ReferenceNo='"+userid+"'";
                        ...
                        JOptionPane.showMessageDialog(null,"Enter Valid Reference Number","",JOptionPane.QUESTION_MESSAGE);
                    }
                }catch(Exception e){
                    e.printStackTrace();
                }
