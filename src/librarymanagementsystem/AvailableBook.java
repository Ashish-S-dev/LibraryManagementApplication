...
public class AvailableBook extends JFrame implements ActionListener {
    JButton ref4;
    JTable table;
    public AvailableBook(){
        ...
        JLabel heading =new JLabel("Book Data");
        heading.setBounds(445,30,210,40);
        ...
        try{
            conn =new Conn();
            String qurey="Select Reference_No,Name,Author,Edition,Category,Branch,Publisher from bookdetails where Availability='Available'";
