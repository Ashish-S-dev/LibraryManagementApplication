...
//        Form part
        ...
        lblstuname.setBounds(550,150,200,20);
        add(lblstuname);
       
        JLabel tfstuname=new JLabel();
        tfstuname.setBounds(850,150,250,20);
        ...
        lbldob.setBounds(550,200,200,20);
        add(lbldob);
       
        JLabel jdcdob=new JLabel();
        jdcdob.setBounds(850,200,250,20);
        ...
        lblgen.setBounds(550,250,200,20);
        add(lblgen);
       
        JLabel tfgender=new JLabel();
        tfgender.setBounds(850,250,250,20);
        ...
        lblnumber.setBounds(550,300,200,20);
        add(lblnumber);
       
        JLabel tfnumber=new JLabel();
        tfnumber.setBounds(850,300,250,20);
        ...
        lblemail.setBounds(550,350,100,20);
        add(lblemail);
       
        JLabel tfemail=new JLabel();
        tfemail.setBounds(850,350,250,20);
        ...
        lbluniver.setBounds(550,400,260,20);
        add(lbluniver);
       
        JLabel tfuniversityrollno=new JLabel();
        tfuniversityrollno.setBounds(850,400,250,20);
       ...
       Conn conn=null;
        ...
        try{
            conn=new Conn();
            ResultSet rs=conn.s.executeQuery("Select * from Teacher where Department='Librarian' and ReferenceNo='"+Login.userid+"'");
            if(rs.next()){
