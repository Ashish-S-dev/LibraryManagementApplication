...
public class UpdateTeacher extends JFrame implements ActionListener{
    Choice tfstuid;
    JLabel tfgender,jdcdob,jcbdoj,tfstuname,tfuniversityrollno;
...
//Form input field start
        ...
        fetchDetails.setFont(new Font("Tahoma",Font.BOLD,18));
        ...
        jcbdoj=new JLabel();
        jcbdoj.setBounds(680,440,100,20);
...
//Enda of the form input field
        ...
        jbsubmit.setBounds(865,485,120,40);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==fetchDetails){
            ...
            if(!tfstuname.getText().equals("")&& !currdate.equals("") && !refno.equals("") && !number.equals("") && !email.equals("") && !dep.equals("")&& !quali.equals("")){
                Conn conn=null;
                try{
                    conn=new Conn();
                    String query="Update Teacher set Number='"+number+"',Email='"+email+"',Department='"+dep+"',Qualification='"+quali+"', ModifyDate='"+currdate+"' where ReferenceNo='"+refno+"'";
